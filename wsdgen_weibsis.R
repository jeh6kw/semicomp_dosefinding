...
changegrid$lambda1 <- rep(c(0.0315,0.0175,0.0095,0.0206,0.0113,0.0062,0.0188,0.0103,0.0056,0.0114,0.0062,0.0034,0.0508,0.0288,0.0154,0.0332,0.0183,0.01),3)
changegrid$lambda2 <- rep(c(0.0148,0.0087,0.0045,0.0088,0.005,0.0027,0.014,0.0078,0.0042,0.0084,0.0046,0.0025,0.0159,0.0097,0.0049,0.0094,0.0054,0.0028),3)
...
library(parallel)
resultSet11 <- mclapply(c(1:54), runSim, N=100, mc.cores = numCores)
save(resultSet11,file="/home/jeh6kw/results_wsdgen_weibsis_11.Rdata")
Sys.time()-r1