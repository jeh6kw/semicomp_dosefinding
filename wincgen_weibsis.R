...
changegrid$type <- rep(c(rep("inc",6),rep("inc_DR35",6),rep("inc_DR65",6)),3)
changegrid$alpha <- 1.1
changegrid$lambda1 <- rep(c(0.0097,0.0054,0.0029,0.0063,0.00345,0.0019,0.0058,0.00315,0.00173,0.00345,0.0019,0.00104,0.0156,0.0088,0.0047,0.0101,0.0056,0.00305),3)
changegrid$lambda2 <- rep(c(0.0046,0.0026,0.00138,0.0027,0.00153,0.00082,0.0043,0.0024,0.0013,0.00255,0.0014,0.00077,0.0049,0.00295,0.0015,0.00284,0.0017,0.00087),3)
...
library(parallel)
resultSet1 <- mclapply(c(1:54), runSim, N=100, mc.cores = numCores)
save(resultSet1,file="/home/jeh6kw/results_wincgen_weibsis_1.Rdata")
Sys.time()-r1